...
public class MessageAdminFlagToServer implements IMessage{
	int x,y,z;
	boolean adminFlag;

	public MessageAdminFlagToServer() {
	}

	public MessageAdminFlagToServer(int x, int y, int z, boolean adminFlag) {
		this.x = x;
		this.y = y;
		this.z = z;
