...
public class MyGuiButton extends GuiButton{
	 ...
	 protected static final ResourceLocation buttonTextures = new ResourceLocation("forestmoon:textures/guis/button15.png");

	public MyGuiButton(int p_i1021_1_, int p_i1021_2_, int p_i1021_3_, int p_i1021_4_, int p_i1021_5_,
			String p_i1021_6_) {
